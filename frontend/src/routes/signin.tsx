        ...
        <div className="relative flex h-full flex-col justify-between p-12 text-white">
          ...
          <div>
            ...
            <p className="mt-4 max-w-md text-white/90">
              Join thousands of environmental researchers and agencies using AtmoAI to make the
              invisible visible.
            </p>
      ...
      <div className="flex items-center justify-center bg-background px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Sign in to continue forecasting air quality.
          </p>

          <button
            onClick={() => navigate({ to: "/app/dashboard" })}
            className="mt-8 flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-background px-4 py-3 text-sm font-semibold transition hover:bg-accent"
          >
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-xl gradient-primary px-4 py-3 text-sm font-semibold text-white shadow-glow transition hover:opacity-95"
            >
