...
const initialAlerts = [
  {
    id: "AL-801",
    category: "Severe Pollution",
    title: "Noida Sector-62 AQI Crossed 210",
    timestamp: "10 mins ago",
    status: "Active",
    severity: "Critical",
    desc: "Local monitors indicate a major PM2.5 spike due to local brick kiln emissions and stagnation.",
  },
  {
    id: "AL-802",
    category: "Emerging Hotspot",
    title: "Indirapuram Area Rising Trend Detected",
    timestamp: "1 hour ago",
    status: "Active",
    severity: "High",
    desc: "A rapid 25% increase in particulate density has been recorded over the last 3 hours.",
  },
  {
    id: "AL-803",
    category: "Health Advisory",
    title: "CO Levels Elevated Near Expressway",
    timestamp: "3 hours ago",
    status: "Active",
    severity: "Moderate",
    desc: "Evening rush hour traffic congestion has caused carbon monoxide levels to hover near 8 ppm.",
  },
  {
    id: "AL-804",
    category: "Weather Impact",
    title: "Atmospheric Inversion Layer Expected Tonight",
    timestamp: "6 hours ago",
    status: "Active",
    severity: "High",
    desc: "Cold air descent will lock particulate particulates close to the ground, deteriorating AQI.",
  },
];
...
function UserAlertSystemView() {
  ...
  return (
    <div className="space-y-8 font-sans">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1.5 text-sm text-muted-foreground font-sans">
            Emergency local notifications, pollution hot-spots warning, and system alert history
          </p>
        </div>
      </div>
              ...
              >
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`rounded-full px-2.5 py-0.5 text-[10px] font-extrabold border ${severityColors}`}
                    >
                      {a.severity}
                    </span>
                  </div>
                ...
                <div className="mt-5 pt-4 border-t border-border/60 flex items-center justify-between">
                  <span
                    className={`text-[10px] font-extrabold uppercase tracking-wider ${isAck ? "text-emerald-600" : "text-amber-500 animate-pulse"}`}
                  >
                    {a.status}
                  </span>
                  {!isAck ? (
      ...
      {/* Alert History Table */}
      <Card
        title="Alert Telemetry History Log"
        subtitle="Record of previous regional alerts and outcomes"
      >
