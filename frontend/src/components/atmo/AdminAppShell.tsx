    ...
    <div className="flex h-screen bg-transparent overflow-hidden">
      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-border px-4">
          ...
          {(collapsed && !mobileOpen) && <div className="mx-auto h-9 w-9 rounded-xl bg-primary shadow-glow" />}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative hidden max-w-md md:flex flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border bg-[rgba(255,255,255,0.60)] backdrop-blur-md py-2 pl-10 pr-4 text-sm placeholder:text-muted-foreground focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
              />
            </div>
          </div>
          <div className="flex items-center gap-3">
